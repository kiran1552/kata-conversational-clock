 ...
 */
public class CloserTransformer implements serenitylabs.tutorials.interfaces.ConversationalTimeFormater {
    @Override
    public String transform(Integer hour, Integer minutes) {
        return "it's "+ HOUR_O_CLOCKS_AND_MINUTE.get((60-minutes))+" to "+ HOUR_O_CLOCKS_AND_MINUTE.get((hour%12) + 1);
    }
